...
public class Jiib {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (pin.matches("\\d{4}")) {
                System.out.println("Kusoo dhawaaw jeep macaamill!");
                break;
            } else {
    ...
    public static void kaarkaHadalka() {
        while (true) {
            ...
            if (airtimeChoice.equals("1") || airtimeChoice.equals("2") || airtimeChoice.equals("3")) {
                ...
                while (true) {
                    System.out.print("\nFadlan geli PIN-kaaga si aad u xaqiijiso: ");
                    String pinConfirm = scanner.nextLine();
                    if (pinConfirm.matches("\\d{4}")) {
                        break;
                    } else {
                        System.out.println("PIN-ka khaldan! Waa inuu noqdaa 4 nambar.");
                    }
                }
    ...
    public static void lacagDirid() {
        ...
        while (true) {
            ...
            if (mobile1.matches("\\d{9}")) {
                break;
            } else {
                System.out.println("Khalad! Mobile-ku waa inuu noqdaa 9 nambar oo kaliya (Tusaale: 619887733).\n");
            }
        }
        ...
        while (true) {
            ...
            if (!mobile2.matches("\\d{9}")) {
                System.out.println("Khalad! Mobile-ku waa inuu noqdaa 9 nambar oo kaliya.");
            } else if (!mobile1.equals(mobile2)) {
                System.out.println("Khalad! Labada lambar isku mid ma aha. Fadlan dib u graac.");
            } else {
                break;
            }
        }
            ...
            if (manageChoice.equals("1")) {
                ...
                while (true) {
                    ...
                    if (phone.matches("\\d+")) {
                        ...
                        System.out.println("error Fadlan geli nambar taleefon oo sax ah.");
                    }
                }
                ...
                while (true) {
                    ...
                    if (txnId.matches("\\d+")) {
                        ...
                        System.out.println("error waa inuu nambar kaliya noqdaa.");
                    }
                }
                System.out.println("Codsigaagii celinta lacagta qaldantay ee TxnID (" + txnId + ") waa la gudbiyay.");
                break;
                ...
                System.out.println("input required, fadlan isku day markale.");
            }
        }
    }
